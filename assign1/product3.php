...
<html lang="en">
	<head>
		...
		<title>SEB Hardware - Gloves</title>
		<link
			rel="stylesheet"
			type="text/css"
		...
		<article>
			<div class="product-hero product-hero--glove">
				<div class="product-hero__container container">
					<h1 class="product-hero__container__title">Gloves</h1>
					<p class="product-hero__container__desc">
						Cover your hands with a layer of protection
					</p>
				</div>
			</div>
			<div class="container">
				<div class="product-grid">
					<?php
						...
						$select_data = "SELECT * FROM products WHERE type = 'glove'";
